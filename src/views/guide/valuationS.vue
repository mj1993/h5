<template>
    <div class="valuation-e">
        <div class="Price ">
            ...
            <div class="dvm">
                <img src="../../assets/images/S@2x.png">
            </div>
          <ul >
            <li>
              <div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            if(baseData[data]){
              this.car = baseData[data].carS.car;
              this.delDataList=baseData[data].delPriceS;
              this.dataList=baseData[data].priceS;
            }else{
              this.car = baseData['default'].carS.car;
              this.delDataList=baseData['default'].delPriceS;
              this.dataList=baseData['default'].priceS;
            }
