...
<div>
  ...
  <div style="display:flex;flex-direction:column;align-items:center" v-if="contentShow">
    ...
    <div style="margin-top:.17rem;height:.18rem"></div>
...
.btn_text_2 {
  ...
  padding: 0; /* 覆盖全局样式 incar-mob-btn 的 padding 设定 */
}
</style>
